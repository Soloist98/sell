                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <#list orderDTOPage.getContent() as orderDTO>
                                <tr>
                                    ...
                                    <td>
                                        <#if orderDTO.getOrderStatusEnum().msg == "新订单未支付" || orderDTO.getOrderStatusEnum().msg == "新订单已支付" >
...
<#--        <source src="/static/mp3/1.mp3" type="audio/mpeg" />-->
        <source src="/sell/mp3/song2.mp3" type="audio/mpeg" />
    </audio>
    ...
    <script>
        ...
        if('WebSocket' in window) {
            websocket = new WebSocket('ws://45.77.127.60:8080/sell/webSocket');
        }else {
